  ...
  },
  {
    ...
    body: {
      ...
      fields: [
        ...
        { name: 'penalGrade', type: 'string', required: true, description: 'Penal Grade (I–V)', enumValues: ['I', 'II', 'III', 'IV', 'V'] },
        { name: 'measureType', type: 'string', required: false, description: 'Gewählte Maßnahme', enumValues: ['FINE', 'SG_ROUNDS'] },
  ...
  return {
    ...
    Sanction: {
      ...
      properties: {
        ...
        measureType: { type: 'string', enum: ['FINE', 'SG_ROUNDS'] },
        fineAmount: { type: ['integer', 'null'] },
        sgRounds: { type: ['integer', 'null'] },
